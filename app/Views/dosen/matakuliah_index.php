...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="card">
                <div class="card-header"><h3 class="card-title">Daftar Mata Kuliah Semester Ini</h3></div>
                <div class="card-body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= site_url('dosen/kelas/detail/' . $matkul['id_matkul']) ?>" class="btn btn-sm btn-info">Lihat Kelas</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
