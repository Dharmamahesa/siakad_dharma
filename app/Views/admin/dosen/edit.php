...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6"><h1 class="m-0">Edit Dosen</h1></div>
                <div class="col-sm-6">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="card card-primary card-outline">
                 <div class="card-header"><h3 class="card-title">Form Edit Dosen</h3></div>
                <div class="card-body">
                    ...
                    <form action="<?= site_url('admin/dosen/update/' . $dosen['id_dosen']) ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nidn" id="nidn" class="form-control" value="<?= esc($dosen['nidn']) ?>" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="kontak" id="kontak" class="form-control" value="<?= esc($dosen['kontak']) ?>">
                        </div>
